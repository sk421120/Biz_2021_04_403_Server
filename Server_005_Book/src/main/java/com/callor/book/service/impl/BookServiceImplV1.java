...
public class BookServiceImplV1 implements BookService {
	...
	public void insert(BookVO bookVO) {
		...
		sql += "(bk_isbn, bk_title, bk_ccode, bk_acode, bk_date, bk_pages, bk_price)";
		sql += "VALUES(?,?,?,?,?,?,?)";
//		sql = VALUES"(" + bookVO.getBk_isbn() +"," ... bookVO.getBk_price() + ")";
		...
		try {
			...
			pStr.setInt(6, bookVO.getBk_pages());
			pStr.setInt(7, bookVO.getBk_price());
			
			pStr.executeUpdate();
			
			pStr.close();
			
			System.out.println("INSERT OK! XD");
