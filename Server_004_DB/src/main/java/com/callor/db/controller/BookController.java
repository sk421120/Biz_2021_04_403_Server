...
// localhost:8080/db/book(URI) 이라고 요청을 하면 localhost:8080 = Tomcat을 호출하는 부분 URL
...
public class BookController extends HttpServlet{
	...
	/*
	 * WAS 관련 프로젝트를 수행할 때 클래스를 만들고 서버를 한번 Run 한 후에
	 * 다시 클래스 코드를 변경하면 Tomcat이 자동으로 재 시작된다
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 ...
		 * 이때 추가된 sub Path를 추출할 때는 req.getpathinfo()를 사용해서 추출한다
		 */
