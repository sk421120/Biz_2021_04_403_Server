 ...
 * 
 * Class class = map.get("이름") 형식으로 값을 읽어서 다른 변수에 담기 가능
 ...
 * key값을 ""로 감싼 문자열 형식으로 사용해야 하기 때문에
 * 많은 오타로 인한 논리적 오류가 발생 할 수 있다
 * 이러한 문제를 방지하기 위해 key 값을 
 * 	별도 static 변수에 만들어 저장하고 활용하는 방법을 사용한다
 */
